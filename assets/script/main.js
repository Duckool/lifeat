...
function musicPlayer() {
    ...
    const bgBody = ["#f8ded3", "#e3c7cb", "#f8ded3", "#e5e7e9", "#ffc382", "#f5eda6", "#ffcbdc", "#dcf3f3", "#ffaacc"];
    ...
    const app = {
        ...
        songs: [
            
            {
                ...
                img: "https://i1.sndcdn.com/artworks-4FqY3ZTQXwD9z59f-JA8yXg-t500x500.jpg"
            },{
                name: "Bật nhạc lên",
                artist: "HIEUTHUHAI",
                path: "./assets/mp3/3/HIEUTHUHAI  Bật Nhạc Lên.mp3",
                img: "https://i1.sndcdn.com/artworks-RIeWY8PZ8isQHTRM-WMoJWg-t500x500.jpg"
            },{
                name: "Timeline",
                artist: "lastlings",
                ...
                img: "https://photo-resize-zmp3.zadn.vn/w600_r1x1_jpeg/cover/2/8/8/9/28890c15a031680fc62e5dccb5de93bf.jpg"
            },
            {
                name: "Talking To The Moon",
                artist: "Bruno Mars",
                path: "./assets/mp3/1/TalkingToTheMoonxPlayDate.mp3",
                img: "https://pbs.twimg.com/profile_images/1238935880297000962/kfC_kHhB.jpg"
            },{
                name: "Công chúa của anh",
                artist: "Rabbiz",
                path: "./assets/mp3/9/Công Chúa Của Anh  Rabbiz.mp3",
                img: "https://i1.sndcdn.com/artworks-000725667451-k2v4u5-t500x500.jpg"
            },{
                name: "Reality",
                artist: "Lost Frequencies",
                path: "./assets/mp3/5/Reality    Lost  Frequencies.mp3",
                img: "https://i.ytimg.com/vi/GIDoQsQyS0s/maxresdefault.jpg"
            },{
                name: "Little Luv",
                artist: "nameless",
        ...
        handleEvents: function() {
            ...
            headerInfo.onclick = function() {
                playerHeader.classList.toggle('open-header')
            }
